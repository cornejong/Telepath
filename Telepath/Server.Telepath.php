    ...
    */
    ...
    public function handle()
    {
        ...
        if($_SERVER['REQUEST_METHOD'] !== "POST") {
            /* If its not a post request, send header 404 and kill the script */
        ...
        switch ($this->request['type']) {
            ...
            case 'method':
                ...
                if(in_array($this->request['content']['method'], $this->instanceMethods)) {
                    ...
                    $classResponse = call_user_func_array(array($this->instance, $this->request['content']['method']), $this->request['content']['parameters']); 
                } else {
